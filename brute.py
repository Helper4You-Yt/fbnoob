...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Helper4You               |"
    print GL+"  |       Super Easy BfBrute tool for you       |"
    print WW+"  |            YOUTUBE: Helper4You              |"
    print Y+"  |             GitHub: Helper4You-yt           |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        NOOB PROGRAMMER [BISHAL]             |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/Helper4You-Yt  "
